...
ExUnit.configure(
  ...
  timeout: 10_000,
  # Exclude slow/chaos tests by default
  exclude: [:slow, :chaos],
...
Mox.defmock(SelfSustaining.MockPerformanceMonitor,
  for: SelfSustaining.PerformanceMonitorBehaviour
)
