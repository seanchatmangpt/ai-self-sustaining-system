defmodule SelfSustaining.TelemetryTest do
  ...
  describe "OpenTelemetry instrumentation" do
    ...
    test "telemetry events are emitted" do
      ...
      assert_receive {:telemetry_event, [:self_sustaining, :test], %{duration: 100},
                      %{test: true}}
    ...
    test "AI telemetry configuration helper" do
      ...
      result =
        OpenTelemetryConfig.ai_span("test_operation", %{"test" => "value"}, fn ->
          "ai_test_result"
        end)
    ...
    test "workflow telemetry configuration helper" do
      ...
      result =
        OpenTelemetryConfig.workflow_span(
          "test_operation",
          TestModule,
          %{"test" => "value"},
          fn ->
  ...
  describe "Error handling in telemetry" do
    test "span creation with error handling" do
      ...
      result =
        OpenTelemetry.Tracer.with_span "error_test_span" do
          try do
            raise "test error"
          rescue
            error ->
