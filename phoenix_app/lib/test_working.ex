defmodule Elixir.SelfSustaining.Extensions.TestWorking.Dsl do
  @moduledoc """
  TestWorking DSL extension following Spark tutorial pattern.
  """

  # Define the Field struct
  defmodule Field do
    @moduledoc """
    Field entity for TestWorking configuration.
    """
...
defmodule Elixir.SelfSustaining.Extensions.TestWorking do
  @moduledoc """
  Main module that provides the TestWorking DSL functionality.
  """

  use Spark.Dsl,
    default_extensions: [
      extensions: [Elixir.SelfSustaining.Extensions.TestWorking.Dsl]
    ]
end
