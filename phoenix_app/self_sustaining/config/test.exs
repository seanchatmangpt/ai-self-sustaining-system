...
config :self_sustaining, SelfSustainingWeb.Endpoint,
  ...
  secret_key_base: "B6GzX1YbzH1p4gexDj3A1GJpOOnieLk+HAFVtbU6lRX43g8Akbh2HeYN8RvC9q/J",
  server: false

# In test we don't send emails
config :self_sustaining, SelfSustaining.Mailer, adapter: Swoosh.Adapters.Test
